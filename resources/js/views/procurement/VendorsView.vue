<template>
    <div>
        <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6">Vendors</h1>
        <DataTable :columns="columns" :data="vendors" searchable>
            <template #header>
        ...
        <ModalDialog v-model="showCreateModal" title="Add Vendor">
